...
[Learn more about Select Target](./select-target/)
...
[Learn more about Time Lock](./set-time-lock/)
...
[Learn more about Variable Lock](./set-variable-lock/)
...
[Learn more about Precondition Lock](./set-precondition-lock/)

### Step 5: Configure Display

Set up how the gate status appears to users:

[Learn more about Display Element](./set-display-element/)
...
[Learn about Select Target](./select-target/)

### Set Time Lock
Configure time-based access control.

[Learn about Set Time Lock](./set-time-lock/)

### Set Variable Lock
Configure data-based visibility.

[Learn about Set Variable Lock](./set-variable-lock/)

### Set Precondition Lock
Configure completion-based access.

[Learn about Set Precondition Lock](./set-precondition-lock/)

### Set Display Element
Configure status message display.

[Learn about Set Display Element](./set-display-element/)
