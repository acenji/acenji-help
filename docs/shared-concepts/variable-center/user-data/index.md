...
[Learn more about Gate Controller](../gate-controller/)
...
[Learn about User Data Variables](./user-data-variables/)

### Add Users to a Group Session
Detailed guide on adding participants to sessions.

[Learn about Adding Users](./add-users-to-a-group-session/)

### Connect to Gate Controller
How to set up access control for your session.

[Learn about Gate Controller Connection](./connect-to-gate-controller/)
