...
1. Select any element on your ACENji page (e.g., a tile, button, card, or image).  
2. Open the **Floating Design Panel** on the right.  
3. Navigate to **Element Section → Events Tab**.

This will display a list of all event types you can attach to the selected element.

![Events Tab in the Floating Design Panel](/images/create-web-application/website-builder/floating-design-panel/element-section/events-tab/events-tab.png)
...
- [Calculate](./calculate/) — Perform math or variable operations on event trigger.  
- [Card Link](./card-link/) — Navigate to another card within your app.  
- [Change Style](./change-style/) — Dynamically change the style of elements when events occur.  
- [Clone Tile](./clone%20tile/) — Duplicate tiles dynamically.  
- [Delete Button](./delete-button/) — Delete specific tiles or elements.  
- [Open URL](./open-url/) — Open external or internal links.
