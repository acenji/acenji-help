...
|------------|-------------|
| [Card Link](../../website-builder/floating-design-panel/element-section/events-tab/card-link/) | Navigate to another page |
| [Open URL](../../website-builder/floating-design-panel/element-section/events-tab/open-url/) | Open external link |
| [Calculate](../../website-builder/floating-design-panel/element-section/events-tab/calculate/) | Perform calculations |
| [Change Style](../../website-builder/floating-design-panel/element-section/events-tab/change-style/) | Modify element appearance |
| [Clone Tile](../../website-builder/floating-design-panel/element-section/events-tab/clone-tile/) | Duplicate a tile |
| [Delete Button](../../website-builder/floating-design-panel/element-section/events-tab/delete-button/) | Remove an element |
