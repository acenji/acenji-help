...
If you want to assign permissions within a specific app, workflow, or dataset, continue to the next section on [App-Level Permissions](#/user-management/app-permissions/).
